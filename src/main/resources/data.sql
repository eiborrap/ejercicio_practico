...
INSERT INTO T_PERSONS (NAME, LASTNAME, DNI) VALUES ('Ana', 'Garcia', '12345678A');
INSERT INTO T_PERSONS (NAME, LASTNAME, DNI) VALUES ('Luis', 'Martinez', '87654321B');
INSERT INTO T_PERSONS (NAME, LASTNAME, DNI) VALUES ('Marta', 'Lopez', '11223344C');
...
VALUES (
  (SELECT ID_PERSON FROM T_PERSONS WHERE DNI = '12345678A'),
  600111222,
  'Calle Mayor 1',
...
INSERT INTO T_CONTACTS (ID_PERSON, TELEPHONE, STREET, EMAIL, DNI)
VALUES (
  (SELECT ID_PERSON FROM T_PERSONS WHERE DNI = '87654321B'),
  600333444,
  'Avenida del Sol 22',
...
INSERT INTO T_CONTACTS (ID_PERSON, TELEPHONE, STREET, EMAIL, DNI)
VALUES (
  (SELECT ID_PERSON FROM T_PERSONS WHERE DNI = '11223344C'),
  600555666,
  'Plaza España 3',
